...
![Валерия Фол](vfol.jpg)

Проф. д.и.н. **Валерия Фол** е включена в екипа на проекта като един от най-знаковите експерти на българската тракология. Понастоящем ръководи Института за научни изследвания в областта на организацията, управлението и защитата на културно-историческото наследство към УниБИТ. Организатор и участник е на множество научни проекти в България и чужбина, с доказани и утвърдени резултати. Познанията и опитът ѝ в сферата на тракийската история и религия са значим принос за българската наука, а сред многобройните ѝ публикации се откроява темата за царската власт и владетелската идеология. Ръководила е значими международни изследователски инициативи, включително по теми като тракийски царски гробници и култови практики, и активно участва в транснационални научни симпозиуми и образователни модулни проекти, признати от UNESCO и национални институции. Без съмнение знанията и опитът на проф. Фол са от ключово значение за успешното реализиране на този проект. Нейната експертиза в изследването на религиозните представи и владетелската идеология е пряко свързана с целите на проекта и ще осигури необходимата научна дълбочина при сравнителния анализ между Египет и Тракия.

> [!NOTE] Профил в Academia.edu: [Валерия Фол](https://bas.academia.edu/ValeriaFol)
